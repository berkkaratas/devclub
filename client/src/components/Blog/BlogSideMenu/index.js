...
export default function BlogSideMenu() {
  return (
    <div className='relative'>
     <div class="col-span-1 w-[280px] fixed flex   flex-col justify-between h-screen bg-gray-900 border-gray-700 border-r ">
  <div class="px-4 py-6">
    ...
    <nav class="fixed top-24 left-6 max-w-[280px] text-white flex-col    space-y-1">
      <a
        href=""
        class="flex items-center px-4 py-2 text-white bg-pink-500 rounded-lg"
      >
        <svg
      ...
      <details class="group">
        ...
        <nav class="mt-1.5 ml-8 flex flex-col">
          ...
          <form action="/logout">
            <button
              type="submit"
              class="flex items-center w-full px-4 py-2 rounded-lg hover:bg-gray-100 hover:text-gray-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-5 h-5 opacity-75"
  ...
  <div class="fixed max-w-[280px] inset-x-0 bottom-0 border-t border-gray-700 fixed left-0 bottom-0 border-gray-700 border-r">
    <a href="" class="flex items-center text-white p-4 bg-gray-900 hover:bg-gray-700 shrink-0">
      <img
