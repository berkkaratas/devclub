...
export default function BlogSideMenu() {
  return (
    <div className='relative'>
     <div className="col-span-1 w-[280px] fixed flex   flex-col justify-between h-screen bg-gray-900 border-gray-700 border-r ">
  ...
  <div className="fixed max-w-[280px] inset-x-0 bottom-0 border-t border-gray-700 fixed left-0 bottom-0 border-gray-700 border-r">
    <a href="/#" className="flex items-center text-white p-4 bg-gray-900 hover:bg-gray-700 shrink-0">
      <img
